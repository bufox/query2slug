...
class Test_Q2S_Lifecycle extends WP_UnitTestCase {
	...
	public function test_activation_sets_default_prefix(): void {
		...
		Q2S_DB::activate();
		$this->assertSame( 'lp', get_option( 'q2s_prefix' ) );
	}

	public function test_activation_sets_flush_transient(): void {
		delete_transient( 'q2s_flush_rewrite' );
		Q2S_DB::activate();
		$this->assertTrue( (bool) get_transient( 'q2s_flush_rewrite' ) );
	}
	...
	public function test_uninstall_cleans_options(): void {
		...
		$this->assertFalse( get_option( 'q2s_prefix' ) );
		$this->assertFalse( get_transient( 'q2s_flush_rewrite' ) );
	}
}
