...
class Test_Q2SLUG_Prefix_Collision extends WP_UnitTestCase {
	...
	public function test_collision_with_page(): void {
		...
		$result = Q2SLUG_Admin::check_prefix_collision( 'landing' );
	...
	public function test_collision_with_post(): void {
		...
		$result = Q2SLUG_Admin::check_prefix_collision( 'my-prefix' );
	...
	public function test_collision_with_rewrite_rule(): void {
		...
		$result = Q2SLUG_Admin::check_prefix_collision( 'testprefix' );
	...
	public function test_collision_with_taxonomy_term(): void {
		...
		$result = Q2SLUG_Admin::check_prefix_collision( 'promo' );
	...
	public function test_no_collision_with_safe_prefix(): void {
		$result = Q2SLUG_Admin::check_prefix_collision( 'lp' );
		$this->assertNull( $result, 'lp should not collide with anything' );
	}

	public function test_no_collision_with_unique_prefix(): void {
		$result = Q2SLUG_Admin::check_prefix_collision( 'q2slug-landing' );
		$this->assertNull( $result, 'q2slug-landing should not collide with anything' );
	}
}
